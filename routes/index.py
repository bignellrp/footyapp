from quart import render_template, request, Blueprint, session, redirect, url_for
...
async def index():
    ...
    if request.method == 'POST':
        ...
        return await render_template('index.html', player_names = player_names, player_count = player_count)